...
<form class="inscription-form" method="post">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="first-name" class="form-control" id="first-name" aria-describedby="firstNameHelp">
  </div>

  <div class="mb-3">
    <label for="last-name" class="form-label">Last Name</label>
    <input type="text" name="last-name" class="form-control" id="last-name" aria-describedby="lastNameHelp">
  </div>
