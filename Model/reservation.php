...
function addReservation(PDO $pdo, int $userId, int $carId, string $startTime, string $endTime)
{
    try {
        $res = $pdo->prepare('INSERT INTO `reservations` (`user_id`, `car_id`, `start_time`, `end_time`, `status`, `parking_id`) VALUES (:user_id, :car_id, :start_time, :end_time, \'waiting\', 10)');
